...
public class MainActivity extends AppCompatActivity {
        ...
        mAuth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    Log.w(LOG_TAG, "signInWIthCredentail: failure", task.getException());
                }
        ...
        mAuth.signInWithEmailAndPassword(emailStr, passwordStr).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    Log.d(LOG_TAG, "User coudln't login");
    ...
    protected void onPause() {
        ...
        editor.putString("emailStr", emailEditText.getText().toString());
        editor.putString("passwordStr", passwordEditText.getText().toString());
        editor.apply();
    ...
    public void loginAsGuest(View view) {
        mAuth.signInAnonymously().addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Log.d(LOG_TAG, "Guest login successfully");
                    startBooking();
                } else{
                    Log.d(LOG_TAG, "Guest log in fail");
                    Toast.makeText(MainActivity.this, "Guest log in fail: " + task.getException().getMessage(), Toast.LENGTH_LONG).show();
